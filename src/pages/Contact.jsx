...
export default function Contact() {
  ...
  const infos = [
    ...
    { id: 2, info: "+33651614177" },
    {
      id: 3,
      info: "LinkedIn",
      link: "https://www.linkedin.com/in/m%C3%A9lanie-courzereaux-115367203/?skipRedirect=true",
    },
      ...
      <section className=" px-5 mt-[20px] md:mt-[76px] relative">
        ...
        <div className="flex justify-between items-start mt-6">
          <div className="flex flex-col gap-1">
            <p className="font4 text-custom-gray uppercase tracking-widest">
              Mélanie Courzereaux
            </p>
        ...
        {isSubmitted ? (
          ...
          >
            <p className="font6 font-bold uppercase">
            ...
            <div className="overflow-hidden whitespace-nowrap">
              <div className="animate-marquee inline-block">
                {Array.from({ length: 6 }).map((_, i) => (
                  <span
                    key={i}
                    className="mx-8 font6 uppercase font-bold inline-flex items-center gap-2"
                  >
                    {t("contact.letsWork")}
                    <StarIcon />
                  </span>
