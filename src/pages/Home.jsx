        ...
        >
          <div className="order-1">
            <div className="flex flex-col gap-1 border-b border-gray-line px-5 py-5">
              <span className="font4 text-custom-gray uppercase">
                {t("home.status")}
              </span>
            ...
            <motion.div
              ...
              className=" border-b group border-gray-line px-5 py-5 "
            >
              <a
                href="CV_Melanie-courzereaux.pdf"
                download="CV_Mélanie-courzereaux.pdf"
                className=" font3 uppercase group flex justify-between items-end cursor-pointer"
              >
                <div className="flex flex-col gap-1">
                  <span className="font4 text-custom-gray dark:group-hover:text-light group-hover:text-dark uppercase">
                    {t("home.resume")}
                  </span>
                  {t("home.download")}
                </div>
            ...
            >
              ...
              >
                <div className="flex flex-col gap-1">
                  <span className="font4 text-custom-gray uppercase dark:group-hover:text-light group-hover:text-dark">
                    {t("home.projects")}
                  </span>
          ...
          <div className="order-2 md:col-span-2 p-8 flex flex-col gap-2.5 group">
            ...
            <span className=" uppercase text-center">
              ★ (
              {
                projects[current].screenshots.find((s) => s.id === "board")
                  ?.feature
              }
              ) ★
            </span>
            <div className="flex gap-2 justify-center">
              {projects.map((p, index) => (
                <div
                  ...
                  className={`rounded-full w-2.5 h-2.5 ${index === current ? "bg-dark dark:bg-light " : "bg-custom-gray"}`}
                ></div>
              ))}
            </div>
