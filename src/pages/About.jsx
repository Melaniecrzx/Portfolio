  ...
  const parcours = [
    {
      ...
      status: t("about.parcours.cdi.status"),
    ...
    },
    {
      ...
      title: "Dassault Systèmes",
      status: t("about.parcours.stage.status"),
      role: t("about.parcours.stage.title"),
    },
    {
      id: 3,
      date: t("about.parcours.ecole.date"),
      title: "ESILV",
      status: t("about.parcours.ecole.status"),
  ...
  const skills = [
    {
      id: 1,
      category: "Frontend",
      items: ["React", "JavaScript", "Tailwind CSS", "Typescript", "Redux"],
    },
    {
      id: 2,
      category: "Backend",
  ...
  return (
    <PageTransition>
      <section className="relative z-20 overflow-hidden px-5 mt-[20px]  md:mt-[76px] flex flex-col gap-[64px]">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex flex-col gap-3">
                <motion.div
                  ...
                  custom={0}
                >
                  <h2 className="font6 font-bold uppercase">
                    ({t("about.title")})
                  </h2>
                ...
                >
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="flex gap-2 items-center">
                      ...
                      <span className="text-custom-gray text-sm">{p.role}</span>
                    </div>
                  </div>
                </motion.div>
              ))}
                ...
                >
                  ...
                  <ul className="flex flex-col gap-1.5">
                    {s.items.map((item, index) => (
                      <li key={index} className="text-custom-gray text-xs">
                        {item}
                      </li>
                    ))}
                  </ul>
        ...
        <span className="text-[40vw] md:text-[20vw] font-black opacity-5 absolute top-[10%] md:-top-[10%] left-[30%] pointer-events-none select-none">
          M
        </span>
        <span className="text-[40vw] md:text-[20vw] font-black opacity-5 absolute top-[20%] md:top-0 left-[50%] pointer-events-none select-none">
          C
        </span>
      </section>
    </PageTransition>
