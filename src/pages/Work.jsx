...
export default function Work() {
  ...
  const projets = [
    ...
    },
    {
      ...
      stack: ["React", "Tailwind", "MongoDB", "Node.JS", "Typescript"],
    },
  ];
    ...
    <PageTransition>
      <section className=" overflow-hidden px-5 mt-[20px]  md:mt-[76px] flex flex-col gap-[48px]">
        ...
        >
          ...
          <p className="font4 text-custom-gray uppercase">
            - 0{projets.length} {t("work.projects")}
          </p>
        </motion.div>
        <motion.div
          initial="hidden"
          ...
          {projets.map((projet) => (
            ...
            >
              <div className="flex justify-between items-center">
                ...
                {projet.link ? (
                  <a
                    ...
                    className="rotate-45 hover:opacity-60 transition-opacity"
                  >
                    <ArrowIcon />
                  </a>
                ) : (
              ...
              <Link to={`/work/${projet.id}`}>
                <div className="relative cursor-crosshair overflow-hidden group">
                ...
                {projet.stack.map((item, index) => (
                  <li key={index}>
                    <motion.div
                      ...
                      className="border text-sm rounded-sm border-custom-gray px-2 text-custom-gray uppercase group-hover:text-dark group-hover:border-dark dark:group-hover:text-light dark:group-hover:border-light transition-colors cursor-default"
                    >
                      {item}
                    </motion.div>
                  </li>
